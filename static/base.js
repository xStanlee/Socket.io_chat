document.addEventListener('DOMContentLoaded', () => {
    ...
    const btn_send = document.getElementsByClassName('container__textarea-btn');
    ...
    socket.on('connect', () => {
                                                                                // When connected, make func (Higher order function)
